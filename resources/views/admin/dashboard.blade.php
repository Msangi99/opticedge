    ...
    <div class="admin-dashboard px-2">
            ...
            <div class="columns is-multiline">
                <div class="column is-12-mobile is-6-tablet is-3-desktop">
                    <div class="dash-metric-card dash-metric-card--sky">
                        ...
                        <p class="title is-4 mb-2">{{ number_format($salesMetrics['today']['sales'], 0) }} <span class="is-size-6 has-text-grey">TZS</span></p>
                ...
                <div class="column is-12-mobile is-6-tablet is-3-desktop">
                    <div class="dash-metric-card dash-metric-card--violet">
                        <div class="dash-metric-card__icon has-background-link-light has-text-link">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <p class="title is-4 mb-2">{{ number_format($salesMetrics['wtd']['sales'], 0) }} <span class="is-size-6 has-text-grey">TZS</span></p>
                ...
                <div class="column is-12-mobile is-6-tablet is-3-desktop">
                    <div class="dash-metric-card dash-metric-card--mint">
                        <div class="dash-metric-card__icon has-background-success-light has-text-success">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <p class="title is-4 mb-2">{{ number_format($salesMetrics['mtd']['sales'], 0) }} <span class="is-size-6 has-text-grey">TZS</span></p>
                ...
                <div class="column is-12-mobile is-6-tablet is-3-desktop">
                    <div class="dash-metric-card dash-metric-card--sun">
                        <div class="dash-metric-card__icon has-background-warning-light has-text-warning">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <p class="title is-4 mb-2">{{ number_format($salesMetrics['ytd']['sales'], 0) }} <span class="is-size-6 has-text-grey">TZS</span></p>
        ...
        @if(isset($financialMetrics))
            <div class="dash-panel">
                <div class="dash-panel__head dash-panel__head--accent">
                    ...
                    <div class="columns is-multiline is-variable is-2">
                        <div class="column is-12-mobile is-6-tablet is-3-desktop">
                            <div class="dash-fin-card dash-fin-card--amber">
                                ...
                                <p class="is-size-7 has-text-grey mt-2 mb-0">Total pending (not paid) from purchases</p>
                            </div>
                        </div>
                        <div class="column is-12-mobile is-6-tablet is-3-desktop">
                            <div class="dash-fin-card dash-fin-card--blue">
                                <p class="heading">Receivables</p>
                                <p class="title is-5">{{ number_format($financialMetrics['receivables'], 0) }} TZS</p>
                                <p class="is-size-7 has-text-grey mt-2 mb-0">Pending from Distribution Sales</p>
                            </div>
                        </div>
                        <div class="column is-12-mobile is-6-tablet is-3-desktop">
                            <div class="dash-fin-card dash-fin-card--green">
                                ...
                                <p class="is-size-7 has-text-grey mt-2 mb-0">Total value of our stock</p>
                            </div>
                        </div>
                        <div class="column is-12-mobile is-6-tablet is-3-desktop">
                            <div class="dash-fin-card dash-fin-card--purple">
                                ...
                                <p class="is-size-7 has-text-grey mt-2 mb-0">Total amount in all payment options</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="columns is-multiline is-variable is-2">
                            <div class="column is-12-mobile is-6-tablet is-3-desktop">
                                <div class="dash-fin-card dash-fin-card--slate">
                                    ...
                                    <p class="is-size-7 has-text-grey mt-2 mb-0">Receivables + Stock + Cash</p>
                                </div>
                            </div>
                            <div class="column is-12-mobile is-6-tablet is-3-desktop">
                                <div class="dash-fin-card dash-fin-card--green">
                            ...
                            <div class="column is-12-mobile is-6-tablet is-3-desktop">
                                <div class="dash-fin-card dash-fin-card--red">
                                    <p class="heading">Total Expenses</p>
                                    <p class="title is-5 has-text-danger">{{ number_format($financialMetrics['total_expenses'], 0) }} TZS</p>
                                    <p class="is-size-7 has-text-grey mt-2 mb-0">From Expenses section</p>
                                </div>
                            </div>
                            <div class="column is-12-mobile is-6-tablet is-3-desktop">
                                <div class="dash-fin-card {{ $financialMetrics['net_profit'] >= 0 ? 'dash-fin-card--green' : 'dash-fin-card--red' }}">
                                    ...
                                    <p class="is-size-7 has-text-grey mt-2 mb-0">Gross profit − Total expenses</p>
                                </div>
                            </div>
                            <div class="column is-12-mobile is-6-tablet is-3-desktop">
                                <div class="dash-fin-card dash-fin-card--blue">
                                    ...
                                    <p class="is-size-7 has-text-grey mt-2 mb-0">Total buy price of all purchases</p>
                                </div>
                            </div>
                            <div class="column is-12-mobile is-6-tablet is-3-desktop">
                                <div class="dash-fin-card dash-fin-card--teal">
                                    ...
                                    <p class="is-size-7 has-text-grey mt-2 mb-0">Total products in all purchases</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        @if(isset($paymentOptions) && $paymentOptions->count() > 0)
            <div class="dash-panel">
                ...
                <div class="dash-panel__body">
                    <div class="columns is-multiline is-variable is-2">
                        @foreach($paymentOptions as $option)
                            ...
                            <div class="column is-12-mobile is-6-tablet is-4-desktop">
                                <div class="dash-payment-card">
                                    <div class="is-flex is-justify-content-space-between is-align-items-center mb-3">
                                        <p class="has-text-weight-semibold">{{ $option->name }}</p>
                                        <span class="tag {{ $typeClass }} is-light is-rounded">{{ ucfirst($option->type) }}</span>
                                    </div>
                                    <p class="title is-4 dash-payment-card__balance mb-0">{{ number_format($currentBalance, 0) }} <span class="is-size-6 has-text-grey">TZS</span></p>
                                    <div class="mt-4 pt-3" style="border-top: 1px solid #f0f2f5;">
                                        ...
                                        @if($difference != 0)
                                            <div class="is-flex is-align-items-center mt-2" style="gap: 0.35rem;">
                                                @if($isIncrease)
                                        ...
                                        @else
                                            <p class="is-size-7 has-text-grey mt-2 mb-0">Hakuna mabadiliko</p>
                                        @endif
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="dash-total-bar">
                        <span class="has-text-weight-semibold">Total Cash in Hand</span>
                        <span class="title is-5 mb-0 has-text-brand-orange">{{ number_format($paymentOptions->sum('balance'), 0) }} TZS</span>
                    </div>
                </div>
            </div>
        @endif
        ...
        <div class="dash-panel">
            <div class="dash-panel__head dash-panel__head--split dash-panel__head--accent">
                <div>
                    <h2 class="title is-5 mb-1">Top Selling Products (Models)</h2>
                    <p class="is-size-7 has-text-grey mb-0">Products sold by quantity</p>
                </div>
                <form method="GET" action="{{ route('admin.dashboard') }}" class="is-flex is-flex-wrap is-align-items-flex-end"
                    style="gap: 0.65rem;">
                    <div class="field mb-0">
                        <label class="label is-size-7 mb-1" for="start_date">Start</label>
                        <div class="control">
                    ...
                    <div class="field mb-0">
                        <label class="label is-size-7 mb-1" for="end_date">End</label>
                        <div class="control">
                    ...
                    <div class="field mb-0">
                        <div class="control">
                            <button type="submit" class="button is-brand is-small">Apply</button>
                        </div>
                    </div>
                </form>
            </div>
            <div class="dash-panel__body">
                @if(count($topProducts) > 0)
                    <div class="dash-chart-area">
                        <canvas id="topProductsChart" style="max-height: 380px;"></canvas>
                    </div>
                @else
                    <div class="dash-empty">No sales data found for the selected date range.</div>
                @endif
            </div>
        </div>

        <div class="dash-panel dash-table-panel">
            <div class="dash-panel__head is-flex is-justify-content-space-between is-align-items-center">
                <h2 class="title is-5 mb-0">Recent Orders</h2>
                <a href="{{ route('admin.orders.index') }}" class="dash-link-action">View all</a>
            </div>
                        ...
                        <tbody>
                            @forelse($recentOrders as $order)
                                <tr>
                                    ...
                                    <td class="has-text-weight-semibold">{{ number_format($order->total_price, 0) }} TZS</td>
                                    <td>
                                        <span class="tag is-light is-rounded {{ $order->status == 'completed' ? 'is-success' : 'is-warning' }}">{{ $order->status }}</span>
                                    </td>
                                    <td class="has-text-right">
                                        <a href="{{ route('admin.orders.show', $order) }}" class="dash-link-action">Details</a>
                                    </td>
                                </tr>
                            @empty
                                <tr>
                                    <td colspan="5" class="dash-empty">No recent orders.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
            ...
            new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        backgroundColor: 'rgba(250, 137, 0, 0.85)',
                        borderColor: '#e67d00',
                        borderWidth: 1,
                        borderRadius: 6
                    }]

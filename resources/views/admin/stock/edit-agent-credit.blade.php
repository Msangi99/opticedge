            ...
            <div class="bg-white rounded-lg shadow-sm border border-slate-200 p-6">
                <form action="{{ route('admin.stock.update-agent-credit', $credit->id) }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label for="installment_amount" class="block text-sm font-medium text-slate-700 mb-1">Installment amount</label>
                                        ...
                                        <tbody>
                                            @foreach($credit->payments as $pay)
                                                <tr class="border-t border-slate-100">
                                                    <td class="px-4 py-2">{{ $pay->paid_date?->format('Y-m-d') ?? '—' }}</td>

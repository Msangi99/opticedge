<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Create Distribution Sale') }}
        </h2>
    </x-slot>

    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="admin-clay-panel overflow-hidden sm:rounded-[1.25rem]">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('admin.stock.store-distribution') }}" class="space-y-6">
                        @csrf
                        ...
                        <div>
                            ...
                            <select id="dealer_id" name="dealer_id" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                        ...
                        <!-- Seller Name (Optional, maybe default to Auth user name) -->
                        <div>
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <a href="{{ route('admin.stock.distribution') }}" class="text-gray-600 hover:text-gray-900">{{ __('Cancel') }}</a>
                        </div>
                    </form>
                </div>
            </div>
